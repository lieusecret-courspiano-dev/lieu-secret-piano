...
export default function AccueilPage() {
  const [settings, setSettings]           = useState({
    site_title: 'Lieu Secret', hero_title: "L'art du piano,", hero_title2: 'a votre rythme',
    hero_subtitle: 'Cours individuels, ateliers de groupe et masterclass en ligne.',
    hero_btn1: 'Reserver un creneau', hero_btn2: 'Decouvrir les offres',
    ...
    apropos_point4: 'Confirmation instantanee par email avec fichier .ics',
    offres_titre: 'Choisissez votre formule', offres_sous_titre: '',
    offre1_titre: 'Cours individuel', offre1_sous: 'Sur mesure', offre1_desc: '', offre1_btn: 'Reserver un creneau',
    offre1_f1: '1h de cours en tete-a-tete', offre1_f2: 'Creneau flexible', offre1_f3: 'Suivi personnalise', offre1_f4: 'Lien Zoom envoye par email',
    offre2_titre: 'Atelier de groupe', offre2_sous: 'Collectif', offre2_desc: '', offre2_btn: 'Voir les ateliers',
    offre2_f1: "Jusqu'a 8 participants", offre2_f2: "Theme defini a l'avance", offre2_f3: 'Echanges et partage', offre2_f4: 'Gratuit ou payant',
    offre3_titre: 'Masterclass', offre3_sous: 'Perfectionnement', offre3_desc: '', offre3_btn: 'Voir les masterclass',
    offre3_f1: 'Niveau intermediaire/avance', offre3_f2: 'Technique approfondie', offre3_f3: 'Petits groupes (6 max)', offre3_f4: 'Enregistrement disponible',
    cta_titre: 'Pret(e) a commencer ?', cta_sous_titre: 'Reservez votre premier cours des maintenant.',
    stats_label1: '100% En ligne', stats_label2: '1h Cours individuel',
    stats_label3: 'Monde entier Fuseaux horaires', stats_label4: 'Tous niveaux Debutant a avance',
    steps_label: 'Simple et rapide', steps_titre: 'Comment ca marche ?',
  })
  ...
  return (
    <div className="min-h-screen bg-noir-950 text-noir-100 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-noir-950/90 backdrop-blur-md border-b border-noir-800/50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/reservation?tab=evenements" className="text-sm text-noir-400 hover:text-gold-400 transition-colors">Evenements</a>
            ...
            <ThemeToggle />
            <a href={instagram} target="_blank" className="text-sm text-noir-400 hover:text-gold-400">Instagram</a>
            <a href={facebook} target="_blank" className="text-sm text-noir-400 hover:text-gold-400">Facebook</a>
        ...
        {menuOpen && (
          <div className="md:hidden bg-noir-900 border-t border-noir-800 px-6 py-4 space-y-3">
            {[
              ...
              { href: '/reservation?tab=evenements',   label: 'Evenements' },
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="font-serif text-5xl md:text-7xl text-white leading-tight mb-6">
            ...
            <br />
            <span className="text-gold-400">{settings?.hero_title2 || 'a votre rythme'}</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-10 mt-16 pt-10 border-t border-noir-800/50">
            {[
              ...
              settings?.stats_label4 || 'Tous niveaux Debutant a avance',
            ].map((s, i) => (
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-noir-300 leading-relaxed mb-6">
                {settings?.apropos_texte1 || "Lieu Secret est une ecole de piano en ligne pensee pour tous les niveaux."}
              </p>
              <p className="text-noir-400 leading-relaxed mb-8">
                {settings?.apropos_texte2 || "Chaque cours est une invitation a explorer la musique dans un cadre chaleureux et professionnel."}
              </p>
              <div className="space-y-3">
                {[
                  settings?.apropos_point1 || 'Cours 100% en ligne via Zoom ou Google Meet',
                  settings?.apropos_point2 || 'Creneaux flexibles adaptes a votre emploi du temps',
                  settings?.apropos_point3 || 'Gestion automatique des fuseaux horaires internationaux',
                  settings?.apropos_point4 || 'Confirmation instantanee par email avec fichier .ics',
                ].map((item, i) => (
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-noir-400 max-w-xl mx-auto">
              {settings?.offres_sous_titre || 'Des cours adaptes a chaque profil, du debutant au musicien confirme.'}
            </p>
          </div>
            ...
            {[
              {
                ...
                desc:     settings?.offre1_desc || 'Un cours dedie entierement a vous.',
                features: [settings?.offre1_f1 || '1h de cours en tete-a-tete', settings?.offre1_f2 || 'Creneau flexible', settings?.offre1_f3 || 'Suivi personnalise', settings?.offre1_f4 || 'Lien Zoom envoye par email'],
                cta:      settings?.offre1_btn || 'Reserver un creneau',
                href:     '/reservation',
                highlight: true,
              },
              {
              ...
              },
              {
                ...
                features: [settings?.offre3_f1 || 'Niveau intermediaire/avance', settings?.offre3_f2 || 'Technique approfondie', settings?.offre3_f3 || 'Petits groupes (6 max)', settings?.offre3_f4 || 'Enregistrement disponible'],
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative rounded-3xl overflow-hidden border border-gold-500/20">
            ...
            <div className="relative z-10 p-12">
              ...
              <h2 className="font-serif text-4xl text-white mb-4">{settings?.cta_titre || 'Pret(e) a commencer ?'}</h2>
              <p className="text-noir-400 mb-8 max-w-md mx-auto">
                {settings?.cta_sous_titre || 'Reservez votre premier cours des maintenant. Aucun engagement, annulation libre.'}
              </p>
              {whatsapp ? (
      ...
      <section id="contact" className="py-16 px-6 border-t border-noir-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            {whatsapp && <a href={`https://wa.me/${whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-green-400 hover:text-green-300 transition-colors text-sm">WhatsApp</a>}
          </div>
      ...
      {/* ── MEDIAS & TEMOIGNAGES ── */}
      {medias.length > 0 && (
        <section className="py-16 px-6 bg-noir-900/30">
          <div className="max-w-6xl mx-auto">
            {/* Temoignages */}
            {medias.filter(m => m.type === 'temoignage').length > 0 && (
              <div className="mb-12">
                <div className="text-gold-500 text-xs tracking-widest uppercase mb-4 text-center">Temoignages</div>
                <h2 className="font-serif text-3xl text-white text-center mb-8">Ce que disent nos eleves</h2>
                <div className="grid md:grid-cols-3 gap-6">
            ...
            {medias.filter(m => m.type === 'video').length > 0 && (
              <div className="mb-12">
                <div className="text-gold-500 text-xs tracking-widest uppercase mb-4 text-center">Videos</div>
                    ...
                    return (
                      <div key={m.id}>
                        <div className="aspect-video rounded-xl overflow-hidden">
                          <iframe src={embedUrl} className="w-full h-full" allowFullScreen title={m.titre || 'Video'} />
                        </div>
