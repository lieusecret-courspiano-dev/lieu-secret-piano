...
export default function AccueilPage() {
      ...
      <nav className={"fixed left-0 right-0 z-50 bg-noir-950/90 backdrop-blur-md border-b border-noir-800/50 transition-all duration-200 " + (showBanner ? "top-10" : "top-0")}>
        <div className="max-w-6xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <ThemeToggle />
            <Link href="/reservation" className="btn-gold text-sm px-3 py-2 hidden sm:inline-flex">Réserver un cours</Link>
  ...
  { href: '/aide', label: 'Aide & FAQ', icon: <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg> },
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          {!settingsLoaded ? (
            ...
            <>
              ...
              <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl text-white mb-4 leading-tight animate-fade-in-up">
                {settings?.hero_title || 'Réservez votre cours de piano'}
              </h1>
              {settings?.hero_title2 && (
                <h2 className="font-serif text-2xl sm:text-3xl md:text-5xl text-gold-400 mb-6 leading-tight">
                  {settings.hero_title2}
                </h2>
              )}
      ...
      <section id="apropos" className="py-12 md:py-24 px-4 md:px-6">
      ...
      <section id="professeur" className="py-12 md:py-24 px-4 md:px-6 bg-noir-900/30">
        <div className="max-w-6xl mx-auto">
      ...
      <section id="offres" className="py-12 md:py-24 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
      ...
      <section className="py-12 md:py-24 px-4 md:px-6 bg-noir-900/30">
      ...
      <section id="temoignages" className="py-12 md:py-24 px-4 md:px-6 bg-noir-900/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
      ...
      <section id="contact" className="py-12 md:py-20 px-4 md:px-6 border-t border-noir-800">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <div className="text-gold-500 text-xs tracking-widest uppercase mb-3">Contact</div>
            <h2 className="font-serif text-3xl md:text-4xl text-white mb-4">Prenons contact</h2>
            <p className="text-noir-400 max-w-md mx-auto">Une question ? Un projet musical ? Nous sommes là pour vous accompagner.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {/* Coordonnées */}
            <div className="card border-gold-500/20">
              <h3 className="text-gold-400 text-xs font-bold uppercase tracking-widest mb-4">Coordonnées</h3>
              <div className="space-y-3">
                {email && (
                  <a href={"mailto:" + email} className="flex items-center gap-3 text-noir-300 hover:text-gold-400 transition-colors group">
                    <div className="w-9 h-9 rounded-xl bg-gold-500/10 border border-gold-500/20 flex items-center justify-center shrink-0 group-hover:bg-gold-500/20 transition-colors">
                ...
                {phone && (
                  <a href={"tel:" + phone} className="flex items-center gap-3 text-noir-300 hover:text-gold-400 transition-colors group">
                    <div className="w-9 h-9 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center shrink-0 group-hover:bg-blue-500/20 transition-colors">
                      <svg width="15" height="15" fill="none" stroke="#60a5fa" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.4 2 2 0 0 1 3.6 1.22h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6.08 6.08l.96-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    </div>
                    <span className="text-sm">{phone}</span>
                  </a>
                )}
                {whatsapp && (
                  <a href={"https://wa.me/" + whatsapp.replace(/[^0-9]/g, "")} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-noir-300 hover:text-green-400 transition-colors group">
                    <div className="w-9 h-9 rounded-xl bg-green-500/10 border border-green-500/20 flex items-center justify-center shrink-0 group-hover:bg-green-500/20 transition-colors">
                      <WhatsAppIcon size={15} />
                    </div>
                    <span className="text-sm">WhatsApp</span>
                  </a>
                )}
                <Link href="/contact" className="flex items-center gap-3 text-noir-300 hover:text-gold-400 transition-colors group mt-2">
                  <div className="w-9 h-9 rounded-xl bg-gold-500/10 border border-gold-500/20 flex items-center justify-center shrink-0 group-hover:bg-gold-500/20 transition-colors">
                    <svg width="15" height="15" fill="none" stroke="#f59e0b" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                  </div>
            ...
            {(instagram || facebook || youtube || tiktok) && (
              <div className="card border-gold-500/20">
                <h3 className="text-gold-400 text-xs font-bold uppercase tracking-widest mb-4">Réseaux sociaux</h3>
                <div className="space-y-3">
                  {instagram && <a href={instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-noir-300 hover:text-pink-400 transition-colors group"><div className="w-9 h-9 rounded-xl bg-pink-500/10 border border-pink-500/20 flex items-center justify-center shrink-0 group-hover:bg-pink-500/20 transition-colors"><Instagram size={15} className="text-pink-400" /></div><span className="text-sm">Instagram</span></a>}
                  {facebook  && <a href={facebook}  target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-noir-300 hover:text-blue-400 transition-colors group"><div className="w-9 h-9 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center shrink-0 group-hover:bg-blue-500/20 transition-colors"><Facebook size={15} className="text-blue-400" /></div><span className="text-sm">Facebook</span></a>}
                  {youtube   && <a href={youtube}   target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-noir-300 hover:text-red-400 transition-colors group"><div className="w-9 h-9 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center shrink-0 group-hover:bg-red-500/20 transition-colors"><Youtube size={15} className="text-red-400" /></div><span className="text-sm">YouTube</span></a>}
                  {tiktok    && <a href={tiktok}    target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-noir-300 hover:text-white transition-colors group"><div className="w-9 h-9 rounded-xl bg-noir-800 border border-noir-700 flex items-center justify-center shrink-0 group-hover:bg-noir-700 transition-colors"><TikTokIcon size={15} /></div><span className="text-sm">TikTok</span></a>}
                </div>
              </div>
            )}
          </div>
      ...
      <footer className="border-t border-noir-800 bg-noir-900 py-10 md:py-14 px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          {/* Ligne principale */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
            ...
            <div className="sm:col-span-2 md:col-span-1">
              ...
              <p className="text-noir-500 text-xs leading-relaxed mb-4">École de Piano en Ligne — Cours individuels, ateliers et événements musicaux.</p>
              {socialLinks.length > 0 && (
                <div className="flex items-center gap-3">
                  {socialLinks.map(s => <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" className="text-noir-600 hover:text-gold-400 transition-colors" title={s.label} aria-label={s.label}>{s.icon}</a>)}
                </div>
              )}
            </div>
            {/* Navigation */}
            <div>
              <p className="text-xs font-bold text-noir-600 uppercase tracking-widest mb-3">Navigation</p>
              <div className="space-y-2">
                <a href="#apropos" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">À propos</a>
                <a href="#professeur" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Votre professeur</a>
                <a href="#offres" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Nos offres</a>
                <a href="#tarifs" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Tarifs</a>
                <a href="#temoignages" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Témoignages</a>
                <a href="#contact" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Contact</a>
              </div>
            </div>
            {/* Services */}
            <div>
              <p className="text-xs font-bold text-noir-600 uppercase tracking-widest mb-3">Services</p>
              <div className="space-y-2">
                <Link href="/reservation" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Réserver un cours</Link>
                <Link href="/essai" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Cours d'essai gratuit</Link>
                <Link href="/packs" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Acheter un pack</Link>
                <Link href="/mon-pack" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Mon pack</Link>
                <Link href="/cadeau" className="block text-xs text-gold-500 hover:text-gold-300 transition-colors">Bon cadeau</Link>
                <Link href="/inscription" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Inscription</Link>
              </div>
            </div>
            {/* Espace élève + contact */}
            <div>
              <p className="text-xs font-bold text-noir-600 uppercase tracking-widest mb-3">Espace élève</p>
              <div className="space-y-2">
                <Link href="/espace-eleve/login" className="block text-xs text-gold-500 hover:text-gold-300 transition-colors font-medium">Connexion élève</Link>
                <Link href="/contact" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Formulaire de contact</Link>
                <Link href="/aide" className="block text-xs text-noir-500 hover:text-gold-400 transition-colors">Aide & FAQ</Link>
                {email && <a href={"mailto:" + email} className="block text-xs text-noir-500 hover:text-gold-400 transition-colors truncate">{email}</a>}
                <a href="/admin/login" className="block text-xs text-noir-800 hover:text-noir-600 transition-colors mt-4">Admin</a>
              </div>
            </div>
          </div>
          {/* Ligne copyright */}
          <div className="border-t border-noir-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-noir-700">© {new Date().getFullYear()} Lieu Secret — École de Piano en Ligne</p>
            <p className="text-xs text-noir-800">Tous droits réservés</p>
          </div>
        </div>
      </footer>
