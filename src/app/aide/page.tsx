...
const FAQ = [
  ...
  { cat: 'Progression', q: "Comment fonctionne le suivi de progression ?", a: "Votre professeur valide vos compétences après chaque cours. Consultez votre progression dans votre espace élève sous 'Ma progression'. Le pourcentage global est calculé automatiquement." },
  { cat: 'Progression', q: "Où trouver mes notes de cours ?", a: "Dans votre espace élève, cliquez sur 'Notes de cours'. Votre professeur y dépose après chaque séance : le résumé du cours, les notions travaillées, les exercices à faire et les objectifs de la semaine." },
  { cat: 'Progression', q: "Comment accéder aux partitions et ressources pédagogiques ?", a: "Dans votre espace élève, cliquez sur 'Partitions' pour accéder à la bibliothèque. Vous pouvez filtrer par niveau et style musical, télécharger les PDF et écouter les fichiers audio associés." },

  // ── Certificats ──
  { cat: 'Certificats', q: "Comment obtenir un certificat ?", a: "Les certificats sont délivrés par votre professeur à l'issue d'une étape importante de votre parcours. Vous recevrez une notification et un email. Téléchargez votre certificat en PDF depuis 'Mes certificats' dans votre espace élève." },
  { cat: 'Certificats', q: "Mes certificats sont-ils officiels ?", a: "Les certificats Lieu Secret attestent de votre progression et des compétences validées par votre professeur. Ils portent un numéro unique (ex: LS-2026-001) et peuvent être partagés ou imprimés." },
