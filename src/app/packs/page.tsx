  ...
  return (
    <div className="min-h-screen bg-noir-950 text-noir-100">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-10"><div className="text-gold-500 text-xs tracking-widest uppercase mb-3">{pageTexts.label}</div><h1 className="font-serif text-4xl text-white mb-4 animate-fade-in-up">{pageTexts.titre}</h1><p className="text-noir-400 max-w-xl mx-auto">{pageTexts.sous_titre}</p></div>
