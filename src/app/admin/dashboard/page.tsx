      ...
      <div className="card mb-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <input type="date" value={from} onChange={e => { setFrom(e.target.value); setActiveShortcut('Personnalisé') }} className="input py-1.5 px-3 text-sm w-40" />
          </div>
          <div className="flex items-center gap-2">
            <label className="text-noir-400 text-xs">Au</label>
            <input type="date" value={to} onChange={e => { setTo(e.target.value); setActiveShortcut('Personnalisé') }} className="input py-1.5 px-3 text-sm w-40" min={from} />
          </div>
