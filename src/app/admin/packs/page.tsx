...
export default function AdminPacks() {
  ...
  const [editForm, setEditForm] = useState({ pack_label: '', heures_total: 5, montant: 100, acheteur_nom: '', acheteur_email: '' })
  ...
  return (
    <div className="p-6 md:p-8 pb-24 md:pb-8">
      ...
      {showCreate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-noir-900 border border-noir-700 rounded-2xl w-full shadow-2xl flex flex-col overflow-hidden" style={{maxWidth:"360px",maxHeight:"88vh"}}>
            {/* Header fixe */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-noir-800 shrink-0">
