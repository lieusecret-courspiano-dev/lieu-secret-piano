...
export async function GET(req: NextRequest) {
  ...
  const { data } = await supabaseAdmin.from('ressources').select('id, titre, description, type, url, categorie, is_public, created_at, eleve_id').order('created_at', { ascending: false })
