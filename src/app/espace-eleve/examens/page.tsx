...
const MEDAILLE = { or: { label: 'Mention Or', color: 'text-yellow-400', icon: '🥇' }, argent: { label: 'Mention Argent', color: 'text-gray-300', icon: '🥈' }, bronze: { label: 'Mention Bronze', color: 'text-orange-400', icon: '🥉' } }
